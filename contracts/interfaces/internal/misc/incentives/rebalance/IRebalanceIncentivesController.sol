...
interface IRebalanceIncentivesController {
    event UpdateRebalanceThresholds(uint256 minDeviation_, uint256 maxDeviation_);
    ...
    function setThresholds(uint256 minDeviation_, uint256 maxDeviation_) external;
